...
class FormsInteractorModule {
    ...
    fun getODKFormsHandler(application: Application): FormsInteractor {
        ...
        val formsInteractor = DaggerFormsInteractorComponent.factory().create(application).getFormsInteractor()
        ...
        val formInstanceInteractor = DaggerFormInstanceInteractorComponent.factory().create(application).getFormInstanceInteractor()
            ...
            return ODKFormsHandler(currentProjectProvider, formsDatabaseInteractor, storagePathProvider, mediaUtils, entitiesRepository,formsNetworkInteractor,formsInteractor,instancesRepository,formInstanceInteractor)
    }
}
